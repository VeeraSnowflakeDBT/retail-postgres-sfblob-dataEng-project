...
# MAGIC %sql
# MAGIC CREATE VIEW retail_postgres.retail_semantic.retail_metrics
# MAGIC WITH METRICS
# MAGIC LANGUAGE YAML
# MAGIC AS $$
# MAGIC version: 1.1
# MAGIC
# MAGIC source: retail_postgres.retail_gold.fact_sales
# MAGIC comment: Retail metrics for analyzing sales transactions, revenue, and product performance
# MAGIC joins:
# MAGIC   - name: product
# MAGIC     source: retail_postgres.retail_gold.dim_product
# MAGIC     on: source.product_id = product.product_id
# MAGIC   - name: calendar
# MAGIC     source: retail_postgres.retail_gold.calendar
# MAGIC     on: source.transaction_date = calendar.date
# MAGIC   - name: customer
# MAGIC     source: retail_postgres.retail_gold.dim_customer
