...
@dp.table(name="retail_postgres.retail_gold.fact_sales")
def fact_sales():
    transactions_df = spark.read.table("retail_postgres.retail_silver.transactions")
    opportunity_df = spark.read.table("retail_postgres.retail_silver.opportunity")
